<template>
  <div class=" dark:text-white text-gray-600 h-screen flex overflow-hidden text-sm">
    <div class=" dark:border-g1 w-20 flex-shrink-0 border-r border-gray-200 flex-col hidden lg:flex">
      <div class="flex mx-auto flex-grow mt-4 flex-col text-gray-400 space-y-4">
        ...
        <button class="p-2 dark:text-g1 rounded-md grid items-center justify-items-center"
          :class="activeRouteClass('dashboard-skills')" @click="goTo('dashboard-skills')" alt="Skills" title="Skills">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 mb-2" stroke-width="2"
            :class="activeRouteSvgClass('dashboard-skills')"
            viewBox="0 0 620 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
            <path
...
const activeRouteSvgClass = (routeName) => {
  return route.name === routeName ? 'fill-white' : 'fill-g1'
}
